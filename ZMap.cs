...
namespace HHSAdvSDL
{
    public class ZMap
    {
        public class ZMapData
        {
            ...
            private int DrawOutline(Canvas c, int offset, SDL.SDL_Color col)
            {
            ...
            public void Draw(Canvas c)
            {
                ...
                c.Cls(c.GetPalleteColor(1));
                int i = DrawOutline(c, vector[0] * 3 + 1, c.GetPalleteColor(7));
                int x0 = vector[i++];
                int y0 = vector[i++];
                ...
                {
                    i = DrawOutline(c, i, c.GetPalleteColor(7));
                }
                if (vector[i] == 0xff && vector[i + 1] == 0xff)
                {
                    i += 2;
                ...
                {
                    i = DrawOutline(c, i, c.GetPalleteColor(0));
                }
                c.tonePaint(vector);
            }
        }
